...
namespace AspireResourceExtensions.AppHost;
...
public static class JavaScriptAppExtension
{
    ...
    public static IResourceBuilder< JavaScriptAppResource > AddCommandsFromPackage(this IResourceBuilder<JavaScriptAppResource> appResource)
    {
        ...
        {
            throw new System.IO.FileNotFoundException($"Could not find package.json at {packageJsonPath}");
        }
        ...
        {
            throw new System.Exception($"No scripts section found in package.json at {packageJsonPath}");
        }
